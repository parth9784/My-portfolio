    ...
    return (
        <section id="hero" className="relative min-h-screen bg-gradient-to-b from-[#0a0a23] to-black text-white overflow-hidden pt-24 sm:pt-28">
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-4xl mx-auto">
                ...
                <h1 className="text-3xl sm:text-5xl md:text-5xl font-light leading-snug mb-4">
                    I'm <span className="font-bold">Parth Dadhich</span>,<br />
                    crafting <span className="italic text-purple-400 font-semibold text-3xl sm:text-4xl md:text-5xl edu-sa">experiences that simplify life</span>
                </h1>
